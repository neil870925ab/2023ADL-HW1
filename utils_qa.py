...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        if do_predict:                      #changed
            context = example["context"]    #for predict, because there is no "relevant" column in the json file
        else:
            context = contexts[example["relevant"]]     #for train and validation
    ...
    if output_dir is not None:
        ...
        logger.info(f"Saving predictions to {prediction_file}.")    #changed
